...
<article class="post" id="books" tabindex="-1">
...
<article class="post" id="browser-extensions" tabindex="-1">

# Browser features[](#browser-extensions)
...
<article class="post" id="brushes" tabindex="-1">
...
<article class="post" id="colors">

# Colors and color palettes[](#colors)
...
<article class="post" id="fonts" tabindex="-1">
...
<article class="post" id="icons" tabindex="-1">

# Icons and emoji[](#icons)
...
<article class="post" id="inspiration" tabindex="-1">

# Inspiration and criticism websites[](#inspiration)
...
<article class="post" id="mocks" tabindex="-1">
...
<article class="post" id="prototyping-tools">
...
<article class="post" id="stock-graphics">
...
<article class="post" id="stock-photography" tabindex="-1">
...
<article class="post" id="user-testing" tabindex="-1">

# User testing and interactive feedback tools[](#user-testing)
